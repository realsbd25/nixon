...
export default function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" ref={ref} className="py-20 bg-zinc-900">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="flex justify-center gap-4 mt-8">
            <button
              ...
              className="w-12 h-12 rounded-full bg-zinc-800 text-white hover:bg-zinc-700 transition-colors flex items-center justify-center"
            >
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all ${
                  index === currentIndex ? 'bg-white w-8' : 'bg-zinc-600'
                }`}
              />
            ))}
          </div>
